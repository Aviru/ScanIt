...
@class ProductOptionsViewController;
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone) {
        ...
        UIImage *buttonImage = [UIImage imageNamed:@"SVWebViewController.bundle/cross_icon"];
        ...
        [button addTarget:self action:@selector(backToApp) forControlEvents:UIControlEventTouchUpInside];
